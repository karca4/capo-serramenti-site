...
import Tende from "@/components/Products/Tende";
...
const productsData: Feature[] = [
  {
    ...
    featurePage: "/product-details/alluminio",
  ...
  },
  {
    ...
    image: "/images/products/ferro.jpg",
    paragraph:
  ...
  },
  {
    ...
    title: "Blindati",
    image: "/images/products/blindati.jpg",
    paragraph:
  ...
  {
    id: "tende",
    image: "/images/products/tende.jpg",
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        <path
          opacity="0.5"
  ...
  {
    id: "interni",
    image: "/images/products/interni.jpg",
    icon: (
