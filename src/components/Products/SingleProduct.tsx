        ...
        <a href={featurePage ?? "#"} className="inline-block mb-12">
          <div className="bg-primary/10 text-primary mb-10 flex h-[70px] w-full items-center justify-center rounded-md">
            <Image
              ...
              width="740"
              height="340"
              className="w-full mx-auto hidden max-w-300 drop-shadow-three dark:block dark:drop-shadow-none lg:mr-0"/>
          </div>
        </a>
        <h3 className="my-5 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl dark:text-white">
          {title}
        </h3>
